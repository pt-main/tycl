...
- **Улучшение контрактов:** поддержка валидации значений (регулярные выражения для строк, диапазоны для чисел, ограничения для массивов).
- **Валидация массивов объектов** в контрактах.
- **Плагин для VS Code:** подсветка синтаксиса, автодополнение, форматирование, проверка контрактов на лету.
- **Парсинг JSON/YAML/TOML в `Config`** для миграции существующих конфигов.
- **Генерация контрактов из конфигов** — автоматическое создание схем.
